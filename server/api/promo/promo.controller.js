...
exports.create = function(req, res) {
  ...
  Pack.findById(req.body.pack,function (err, pack) {
    ...
    if (req.body.tags) {
      if (req.body.tags.en) {
        req.body.tags.en.split(",").join(" ");
        req.body.tags.en = req.body.tags.en.split(' ');
      };
      if (req.body.tags.es) {
        req.body.tags.es.split(",").join(" ");
        req.body.tags.es = req.body.tags.es.split(' ');
      };
    }
...
exports.update = function(req, res) {
  ...
  if (req.body.tags) {
    if (req.body.tags.en) {
      req.body.tags.en = req.body.tags.en.split(",").join(" ");
      req.body.tags.en = req.body.tags.en.split(' ');
    };
    if (req.body.tags.es) {
      req.body.tags.es = req.body.tags.es.split(",").join(" ");
      req.body.tags.es = req.body.tags.es.split(' ');
    };
  }
...
exports.visited = function(req, res) {
  ...
  Promo.findById(req.params.id, function (err, promo) {
    ...
    tenVisited = parseInt(promo.likes.visited / 4);
